...
%TODO: Missed lecture (biodiversity) notes - Looks weird, lets wait
% and see for the practice exam questions
...
% Generalised seizures:
  % Tonic clonic seizure is a movie style seizure; body jerk, froth at
  % the mouth... then paralysis Absence seizure; go blank for a few
  % seconds Myoclonic seizure; twitching of a muscle/muscle group
...
% Diagnosis & treatment:
% Rule out other causes; get an eyewitness 
