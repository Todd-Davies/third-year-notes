...
This information is usually held in a seperate datastructure from the
...
specutiavely read a thread before it was ready. The most simple
...
resource. Clasically, we would need to use a lock to make sure the
