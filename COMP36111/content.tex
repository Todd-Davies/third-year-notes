...
problem, we compute in log space (since we want a many-one log reduction (see
Section~\ref{sec:reduce-and-hard})), a function to create a graph from the
satisfiability problem's clauses.
...
% Todo: Carry on from the graphs bit (lecture 9, graph bit is above somewhere)